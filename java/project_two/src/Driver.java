...
public class Driver {
    ...
    public static void initializeMonkeyList() {
        Monkey monkey1 = new Monkey("Bam Bam", "Capuchin", "5.2", "9.4", "19.6", "female", "2", "15.3", "09-11-2019",
                "Canada", "Phase I", true, "Canada");
        Monkey monkey2 = new Monkey("Buddha", "Macaque", "4.8", "10.2", "20.7", "male", "1", "17.4", "12-05-2020",
                "United Kingdom", "in service", false, "United Kingdom");
        Monkey monkey3 = new Monkey("Carli", "Tamarin", "5.5", "8.6", "18.4", "female", "3", "18.2", "12-10-2019",
    ...
    public static void intakeNewMonkey(Scanner scanner) {
        ...
        if (!(speciesList.stream().anyMatch(species::equalsIgnoreCase))) {
            System.out.println("\n\nInvalid monkey species!\n\n");
            return;
        }
        ...
        String acquiredFrom = scanner.nextLine();
        System.out.println("What is the monkey's training status?");
        String trainingStatus = scanner.nextLine();
        System.out.println("Is the monkey reserved?");
        boolean ifReserved = scanner.nextBoolean();
        scanner.nextLine();
        System.out.println("What is the monkey's in Service Country?");
        String isInService = scanner.nextLine();
        Monkey newmonkey = new Monkey(name, species, tailLength, height, bodyLength, gender, age, weight, acquiredDate,
                acquiredFrom, trainingStatus, ifReserved, isInService);
